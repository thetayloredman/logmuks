...
const UserExtendedProfile = ({
	...
	const lurkDashboardUrl = `https://metrics.zirco.dev/d/adwlhd7/read-receipts-from-user`
		+ `?from=now-2d&to=now&timezone=browser&var-user=${userID}`
	const viewButtons = <div className="view-buttons">
		...
		<button onClick={() => openUrl(lurkDashboardUrl)}>Read receipts</button>
	</div>
